  ...
  params: {
    ...
    privateEndpoints: empty(privateEndpointSubnetId)
      ...
      : [
          ...
          {
            name: '${name}-queue-pe'
            privateDnsZoneGroup: empty(queuePrivateDnsZoneResourceId)
              ? null
              : {
                  privateDnsZoneGroupConfigs: [
                    {
          ...
          {
            name: '${name}-table-pe'
            privateDnsZoneGroup: empty(tablePrivateDnsZoneResourceId)
              ? null
              : {
                  privateDnsZoneGroupConfigs: [
                    {
...
output AZURE_STORAGE_SERVICE_ENDPOINTS object = storageAccount.outputs.serviceEndpoints
